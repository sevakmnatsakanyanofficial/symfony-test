 ...
 */
final class Version20231205013835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT NOT NULL, type SMALLINT NOT NULL, code VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
